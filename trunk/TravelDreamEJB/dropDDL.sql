...
ALTER TABLE GIFTLIST DROP FOREIGN KEY FK_GIFTLIST_OWNER_EMAIL
ALTER TABLE PERSONALIZEDTRAVELPACKAGE DROP FOREIGN KEY FK_PERSONALIZEDTRAVELPACKAGE_OWNER_EMAIL
ALTER TABLE TRAVELELEMENT DROP FOREIGN KEY FK_TRAVELELEMENT_TRAVEL_COMPONENT_ID
ALTER TABLE TRAVELELEMENT DROP FOREIGN KEY FK_TRAVELELEMENT_OWNER_EMAIL
ALTER TABLE USER_GROUP DROP FOREIGN KEY FK_USER_GROUP_GROUPNAME
ALTER TABLE USER_GROUP DROP FOREIGN KEY FK_USER_GROUP_EMAIL
