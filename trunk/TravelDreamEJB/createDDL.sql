...
CREATE TABLE GROUP (GROUPNAME VARCHAR(255) NOT NULL, PRIMARY KEY (GROUPNAME))
...
ALTER TABLE USER_GROUP ADD CONSTRAINT FK_USER_GROUP_GROUPNAME FOREIGN KEY (GROUPNAME) REFERENCES GROUP (GROUPNAME)
