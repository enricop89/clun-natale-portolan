CREATE TABLE COMPONENTS_HELPER (ID BIGINT AUTO_INCREMENT NOT NULL, EXCURSIONCITY VARCHAR(255), EXCURSIONDATETIME DATETIME, EXCURSIONDESCRIPTION VARCHAR(255), FLIGHTARRIVALCITY VARCHAR(255), FLIGHTARRIVALDATETIME DATETIME, FLIGHTCODE VARCHAR(255), FLIGHTDEPARTURECITY VARCHAR(255), FLIGHTDEPARTUREDATETIME DATETIME, FLIGHTTYPE INTEGER, HOTELCITY VARCHAR(255), HOTELDATE DATE, SUPPLYINGCOMPANY VARCHAR(255), TYPE VARCHAR(255), PERSONALIZED_TRAVEL_PACKAGE_ID BIGINT, TRAVELCOMPONENT_ID BIGINT, TRAVELELEMENT_ID BIGINT, PRIMARY KEY (ID))
...
CREATE TABLE TRAVELCOMPONENT (ID BIGINT AUTO_INCREMENT NOT NULL, EXCURSIONCITY VARCHAR(255), EXCURSIONDATETIME DATETIME, EXCURSIONDESCRIPTION VARCHAR(255), FLIGHTARRIVALCITY VARCHAR(255), FLIGHTARRIVALDATETIME DATETIME, FLIGHTCODE VARCHAR(255), FLIGHTDEPARTURECITY VARCHAR(255), FLIGHTDEPARTUREDATETIME DATETIME, FLIGHTTYPE INTEGER, HOTELCITY VARCHAR(255), HOTELDATE DATE, SUPPLYINGCOMPANY VARCHAR(255), TYPE VARCHAR(255), PRIMARY KEY (ID))
