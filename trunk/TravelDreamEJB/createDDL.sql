...
CREATE TABLE USERS (USERNAME VARCHAR(255) NOT NULL, EMAIL VARCHAR(255), FIRSTNAME VARCHAR(255), LASTNAME VARCHAR(255), PASSWORD VARCHAR(255), PRIMARY KEY (USERNAME))
...
ALTER TABLE GIFTLIST ADD CONSTRAINT FK_GIFTLIST_OWNER_USERNAME FOREIGN KEY (OWNER_USERNAME) REFERENCES USERS (USERNAME)
ALTER TABLE PERSONALIZEDTRAVELPACKAGE ADD CONSTRAINT FK_PERSONALIZEDTRAVELPACKAGE_OWNER_USERNAME FOREIGN KEY (OWNER_USERNAME) REFERENCES USERS (USERNAME)
...
ALTER TABLE TRAVELELEMENT ADD CONSTRAINT FK_TRAVELELEMENT_OWNER_USERNAME FOREIGN KEY (OWNER_USERNAME) REFERENCES USERS (USERNAME)
ALTER TABLE USER_GROUP ADD CONSTRAINT FK_USER_GROUP_USERNAME FOREIGN KEY (USERNAME) REFERENCES USERS (USERNAME)
