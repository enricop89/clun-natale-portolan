CREATE TABLE COMPONENTS_HELPER (ID BIGINT AUTO_INCREMENT NOT NULL, EXCURSIONCITY VARCHAR(255), EXCURSIONDATETIME DATETIME, EXCURSIONDESCRIPTION VARCHAR(255), FLIGHTARRIVALCITY VARCHAR(255), FLIGHTARRIVALDATETIME DATETIME, FLIGHTCODE VARCHAR(255), FLIGHTDEPARTURECITY VARCHAR(255), FLIGHTDEPARTUREDATETIME DATETIME, HOTELCITY VARCHAR(255), HOTELDATE DATE, SUPPLYINGCOMPANY VARCHAR(255), TYPE VARCHAR(255), PERSONALIZED_TRAVEL_PACKAGE_ID BIGINT, TRAVELCOMPONENT_ID BIGINT, TRAVELELEMENT_ID BIGINT, PRIMARY KEY (ID))
CREATE TABLE GIFTELEMENTS_HELPER (ID BIGINT AUTO_INCREMENT NOT NULL, GIFT_LIST_ID VARCHAR(255), PERSONALIZEDTRAVELPACKAGE_ID BIGINT, TRAVELCOMPONENT_ID BIGINT, PRIMARY KEY (ID))
...
CREATE TABLE PERSONALIZEDTRAVELPACKAGE (ID BIGINT AUTO_INCREMENT NOT NULL, DEPARTUREDATE DATE, NAME VARCHAR(255), RETURNDATE DATE, OWNER_EMAIL VARCHAR(255) NOT NULL, PRIMARY KEY (ID))
CREATE TABLE PREDEFINEDTRAVELPACKAGE (ID BIGINT AUTO_INCREMENT NOT NULL, DEPARTUREDATE DATE, DESCRIPTION VARCHAR(255), NAME VARCHAR(255), RETURNDATE DATE, PRIMARY KEY (ID))
...
CREATE TABLE USERS (EMAIL VARCHAR(255) NOT NULL, FIRSTNAME VARCHAR(255), LASTNAME VARCHAR(255), PASSWORD VARCHAR(255), PRIMARY KEY (EMAIL))
...
ALTER TABLE GIFTELEMENTS_HELPER ADD CONSTRAINT FK_GIFTELEMENTS_HELPER_TRAVELCOMPONENT_ID FOREIGN KEY (TRAVELCOMPONENT_ID) REFERENCES COMPONENTS_HELPER (ID)
...
INSERT INTO GROUPS VALUES("EMPLOYEE")
INSERT INTO USERS VALUES("traveldreamcnp@gmail.com","TravelDream","Employee","b165a5ed5722ad77f3ef76fa9fc3de02f41a4370a91667c5f908def706392761") #password "polimi"
INSERT INTO USER_GROUP VALUES("EMPLOYEE","traveldreamcnp@gmail.com")